...
namespace Rock.ViewModels.Blocks.Group.GroupDetail
{
    ...
    /// <c>GroupTypeGroupMemberWorkflowTriggerBag</c> sibling shape but
    /// scoped to per-group triggers. The pipe-delimited 7-tuple
    /// <c>TypeQualifier</c> persisted on the entity is decomposed into
    ...
    public class GroupMemberWorkflowTriggerBag
    {
        ...
        /// fires. <c>ListItemBag.value</c> is the WorkflowType Guid.
        /// </summary>
        ...
        /// <see cref="GroupMemberWorkflowTriggerType.MemberStatusChanged"/>.
        /// Null = Any.
        /// </summary>
        ...
        /// <see cref="GroupMemberWorkflowTriggerType.MemberRemovedFromGroup"/>
        ...
        /// <see cref="GroupMemberWorkflowTriggerType.MemberRoleChanged"/>.
        /// Null = Any.
        /// </summary>
        ...
        /// <see cref="GroupMemberWorkflowTriggerType.MemberAttendedGroup"/>.
        /// </summary>
        ...
        /// <see cref="GroupMemberWorkflowTriggerType.MemberPlacedElsewhere"/>.
        /// </summary>
