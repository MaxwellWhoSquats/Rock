...
namespace Rock.ViewModels.Blocks.Group.GroupDetail
{
    ...
    /// Mirrors <see cref="GroupMemberInheritedAttributeBag"/> in shape.
    /// </summary>
    public class InheritedGroupRequirementBag
    {
        ...
        /// <c>GroupRequirementType.Name</c>).
        /// </summary>
        public string Name { get; set; }

        /// <summary>
        /// Gets or sets the group role name this requirement applies to.
        /// Empty when the requirement applies to any role.
        /// </summary>
