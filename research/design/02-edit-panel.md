...
8. **Image uploader data source** — New Image field. Where does the binary file Id persist on the Group entity? `Group.PhotoId` exists; verify whether to use it or add a new column.
