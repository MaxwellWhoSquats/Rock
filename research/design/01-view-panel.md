...
3. **Group image data source** — Is this `Group.PhotoId` (existing nullable column) or a new field? Image uploader behavior (stored binary file vs Person photo pattern) needs confirmation.
